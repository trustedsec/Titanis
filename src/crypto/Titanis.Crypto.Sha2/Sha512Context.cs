...
{
	public partial struct Sha512Context : IHashContext, IHashBuffer
	{
		internal Sha2LargeContext<Sha512Policy> ctx;

		public int DigestSizeBytes => 512 / 8;
		public static int StaticDigestSizeBytes => 512 / 8;
	...
	struct Sha512Policy: ISha2LargePolicy
	{
		public int DigestSize => 512 / 8;
