...
{
	public class SamUserAllInfo
	{
		private SAMPR_USER_ALL_INFORMATION info;

		internal SamUserAllInfo(in SAMPR_USER_ALL_INFORMATION info)
		{
			this.info = info;
		}
		...
		public DateTime? AccountExpires => this.info.AccountExpires.AsNullableDateTime();
		...
		public string Parameters => this.info.Parameters.AsString();
		...
		public bool IsPasswordExpired => (0 != this.info.PasswordExpired);
