...
namespace Titanis.Security.Kerberos
{
	public sealed class KerberosClientCred
	{
		...
		public KerberosClientCred(UserPrincipalName u2UserName)
		{
		...
		public static implicit operator KerberosClientCred(UserPrincipalName u2UserName) => new KerberosClientCred(u2UserName);
	}
	...
	public abstract class KerberosClientContextBase : AuthClientContext
	{
		...
		public TicketInfo? Ticket => this._clientCred.Ticket;
		...
		protected sealed override ReadOnlySpan<byte> InitializeImpl()
		{
			...
			if (this._clientCred.Ticket is null)
			{
