...
namespace Titanis.Security.Kerberos
{
	...
	public abstract class EncProfile
	{
		...
		/// <summary>
		/// Gets the size of data generated by <see cref="PseudoRandom(ReadOnlySpan{byte}, ReadOnlySpan{byte}, Span{byte})"/>.
		/// </summary>
		internal virtual int PrfSizeBytes => 0;
		/// <summary>
		...
		/// <remarks>
		/// The caller must allocate <paramref name="outputBuffer"/> to hold <see cref="PrfSizeBytes"/>.
		/// </remarks>
		internal virtual void PseudoRandom(ReadOnlySpan<byte> protocolKey, ReadOnlySpan<byte> seed, Span<byte> outputBuffer)
		{
