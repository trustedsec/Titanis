...
# Scm
_comp_Scm () {
	_comp_T_subcommands "$1" "$2" create delete qtriggers query start stop
	return $?
}
complete -F _comp_Scm Scm
...
_comp_Scm_create () {
	declare -A params=(
		...
		['-binpath']=$'BinPath::'
		['-servicetype']=$'ServiceType:list:None;KernelDriver;FileSystemDriver;OwnProcess;SharedProcess;All'
		['-starttype']=$'StartType:list:Boot;System;Auto;Demand;Disabled'
		['-errorcontrol']=$'ErrorControl:list:Ignore;Normal;Severe;Critical'
...
complete -F _comp_Scm_create Scm-create
...
complete -F _comp_Scm_delete Scm-delete
...
_comp_Scm_qtriggers () {
	declare -A params=(
		...
		['-servername']=$'ServerName::'
		['-consoleoutputstyle']=$'ConsoleOutputStyle:list:Freeform;Raw;Table;List;Csv;Tsv;Json;TreeTable'
		['-outputfields']=$'OutputFields:list:ServiceName;TriggerType;TriggerTypeDescription;Action;Data0'
		['-outputheaders']=$'OutputHeaders::'
		['-loglevel']=$'LogLevel:list:Debug;Diagnostic;Verbose;Info;Warning;Error;Critical'
		['-consolelogformat']=$'ConsoleLogFormat:list:Text;TextWithTimestamp;Json'
		['-verbose']=$'Verbose::'
...
complete -F _comp_Scm_qtriggers Scm-qtriggers

# Scm query
_comp_Scm_query () {
	declare -A params=(
		['-types']=$'Types:list:None;KernelDriver;FileSystemDriver;OwnProcess;SharedProcess;All'
		['-states']=$'States:list:None;Active;Inactive;All'
		['-servername']=$'ServerName::'
		['-consoleoutputstyle']=$'ConsoleOutputStyle:list:Freeform;Raw;Table;List;Csv;Tsv;Json;TreeTable'
		['-outputfields']=$'OutputFields:list:ServiceName;DisplayName;ServiceType;State;Win32ExitCode;SpecificExitCode'
		['-outputheaders']=$'OutputHeaders::'
		['-loglevel']=$'LogLevel:list:Debug;Diagnostic;Verbose;Info;Warning;Error;Critical'
		['-consolelogformat']=$'ConsoleLogFormat:list:Text;TextWithTimestamp;Json'
		['-verbose']=$'Verbose::'
...
complete -F _comp_Scm_query Scm-query
...
complete -F _comp_Scm_start Scm-start
...
complete -F _comp_Scm_stop Scm-stop
