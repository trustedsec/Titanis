...
# Dsrep
_comp_Dsrep () {
	_comp_T_subcommands "$1" "$2" dcinfo rep repnc
	return $?
}
complete -F _comp_Dsrep Dsrep

# Dsrep dcinfo
_comp_Dsrep_dcinfo () {
	declare -A params=(
		['-accept2003deflate']=$'Accept2003Deflate::'
		['-servername']=$'ServerName::'
		['-consoleoutputstyle']=$'ConsoleOutputStyle:list:Freeform;Raw;Table;List;Csv;Tsv;Json;TreeTable'
		['-outputfields']=$'OutputFields:list:NetbiosName;DnsHostName;SiteName;SiteObjectName;ComputerObjectName;ServerObjectName;NtdsDsaObjectName;IsPdc;IsDsEnabled;IsGc;SiteObjectGuid;ComputerObjectGuid;ServerObjectGuid;NtdsDsaObjectGuid'
...
complete -F _comp_Dsrep_dcinfo Dsrep-dcinfo
...
_comp_Dsrep_rep () {
	declare -A params=(
		...
		['-exportkeytab']=$'ExportKeytab::'
		['-fromusnvec']=$'FromUsnvec::'
		['-chunkobjectlimit']=$'ChunkObjectLimit::'
...
complete -F _comp_Dsrep_rep Dsrep-rep
...
complete -F _comp_Dsrep_repnc Dsrep-repnc
