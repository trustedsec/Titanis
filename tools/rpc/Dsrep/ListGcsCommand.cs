...
[Command]
[Description("List GCs in a forest")]
public class ListGcsCommand : DsbindCommand
{
	...
	{
		var names = await dsbind.GetGlobalCatalogServers(this.NameFormat, cancellationToken);
