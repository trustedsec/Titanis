...
[Command]
[Description("List partitions (naming contexts) in a forest")]
public class ListPartitionsCommand : DsbindCommand
{
	...
	{
		var names = await dsbind.GetPartitions(this.NameFormat, cancellationToken);
